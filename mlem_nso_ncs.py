...
def compute_r_v_2(Y, Theta, dist):
...
def torch_mle_minibatch(Y, Theta, dist):
...
PROJECT_NAME = 'human_nso_ncs_norm'
#PROJECT_NAME = 'human_nso_ncs_stuT'

#PROJECT_NAME = 'mouse_nso_ncs_norm'
...
mle1 = torch_mle_minibatch(Y, Theta, 'normal')
#mle1 = torch_mle_minibatch(Y, Theta, 'student')
